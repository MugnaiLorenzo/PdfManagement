...
protected:
    ...
    SplitPage *ex;
    virtual void SetUp() {
        std::string file_name="TestMaterials/sanudo_i_diarii_tomo_v.pdf";
        QString Qfile_name = QString::fromStdString(file_name);
        const char *file= file_name.c_str();
        Pdf *pdf= new Pdf(file,Qfile_name, "10");
        std::string path="TestMaterials/prova1.pdf";
...
void SplitTest::executeTest(){
    ...
    ex->execute();
    Pdf *pdf1= new Pdf("TestMaterials/prova1.pdf","TestMaterials/prova1.pdf", "11");
